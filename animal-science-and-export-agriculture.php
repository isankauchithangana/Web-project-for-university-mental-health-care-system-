...
<body>
  ...
  <section class="users">
    <h1 class="form-title">Faculty of Animal Science and Export Agriculture</h1>
    ...
    <div class="dashboard-count col-md-2 col-sm-4 col-xs-6">
      <div class="dashboard-box">
        ...
        <div class="dashboard-number">
          <p class="count"><?php echo geteagCount(); ?></p>
          <p class="dashboard-section">Students</p>
          <h4 class="faculty-name">EAG</h4><br>
        </div>
      </div>
      <a href="eag.php" class="btn btn-primary">Access</a>
    </div>
      ...
      <div class="dashboard-box">
        <i class="fa fa-users"></i>
        <div class="dashboard-number">
          <p class="count"><?php echo getaqtCount(); ?></p>
          <p class="dashboard-section">Students</p>
          <h4 class="faculty-name">AQT</h4><br>
        </div>
      </div>
      <a href="aqt.php" class="btn btn-primary">Access</a>
    </div>
      ...
      <div class="dashboard-box">
        <i class="fa fa-users"></i>
        <div class="dashboard-number">
          <p class="count"><?php echo getpltCount(); ?></p>
          <p class="dashboard-section">Students</p>
          <h4 class="faculty-name">PLT</h4><br>
        </div>
      </div>
      <a href="plt.php" class="btn btn-primary">Access</a>
    </div>
    ...
    <div class="dashboard-count col-md-2 col-sm-4 col-xs-6">
      <div class="dashboard-box">
        <i class="fa fa-users"></i>
        <div class="dashboard-number">
          <p class="count"><?php echo getansCount(); ?></p>
          <p class="dashboard-section">Students</p>
          <h4 class="faculty-name">ANS</h4><br>
        </div>
      </div>
      <a href="ans.php" class="btn btn-primary">Access</a>
    </div>
    ...
    <div class="dashboard-count col-md-2 col-sm-4 col-xs-6">
      <div class="dashboard-box">
        <i class="fa fa-users"></i>
        <div class="dashboard-number">
          <p class="count"><?php echo getteaCount(); ?></p>
          <p class="dashboard-section">Students</p>
          <h4 class="faculty-name">TEA</h4><br>
        </div>
      </div>
      <a href="tea.php" class="btn btn-primary">Access</a>
    </div>
