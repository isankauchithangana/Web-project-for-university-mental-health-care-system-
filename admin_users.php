...
<body>
    ...
    <aside class="left-sidebar">
      ...
      <div class="logo">
        <img src="assets\images\logo1.png" alt="Logo" style="display: block; margin: 0 auto;">
         ...
         <div class="content">
          <?php 
            $sql = mysqli_query($conn, "SELECT * FROM mentorusers WHERE unique_id = {$_SESSION['unique_id']}");
  ...
  <div class="wrapper">
    <section class="users">
   <h1 class="chat-title">Student Massages</h1>
      <div class="search">
        <span class="text">Search Students</span>
  ...
  <script src="admin-javascript/users.js"></script>
